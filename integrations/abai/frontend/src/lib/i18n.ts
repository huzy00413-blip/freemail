...
const EN_MESSAGES: Record<TranslationKey, string> = {
  ...
  "welcome.title": "Join the Project Community",
  "welcome.desc": "Scan the QR code or use the link below to join the QQ group for tutorials and updates.",
